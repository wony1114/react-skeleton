...
const list = count => dispatch => {
    const request = user => {
        return {type: userConstants.LIST_REQUEST, user}}
    const success = user => {
        return {type: userConstants.LIST_SUCCESS, user}}
    const failure = user => {
        return {type: userConstants.LIST_FAILURE, user}}
}
const detail = userid => dispatch => {
    ...
    const failure = user => {
        return {type: userConstants.DETAIL_FAILURE, user}}
}
